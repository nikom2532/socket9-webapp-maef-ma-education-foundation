...
if (substr(JVERSION, 0, 3) >= '1.6') {
	...
	<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
		<fieldset class="word">
			<label for="search-searchword"> <?php echo JText::_('COM_SEARCH_SEARCH_KEYWORD'); ?> </label><br />
		...
		<?php endif; ?>
		<p>
			<button name="Search" onclick="this.form.submit()" class="button zenbutton"><span><?php echo JText::_('COM_SEARCH_SEARCH');?></span></button>
		</p>
		<?php if ($this->total > 0) : ?>
		<div class="display">
	...
	<form action="<?php echo JRoute::_( 'index.php?option=com_search#content' ) ?>" method="post" class="search_result<?php echo $this->escape($this->params->get('pageclass_sfx')) ?>">
		...
		<fieldset class="word">
			...
			<input type="text" name="searchword" id="search_searchword" value="<?php echo $this->escape($this->searchword) ?>" class="inputbox" />
		</fieldset>
		<fieldset class="phrase">
			<legend><?php echo JText::_('Search Parameters') ?></legend>
			<?php echo $this->lists['searchphrase']; ?> <br />
			<br />
		...
		<?php endif; ?>
		<p>
			<button name="Search" onclick="this.form.submit()" class="button zenbutton"><span><?php echo JText::_( 'Search' );?></span></button>
		</p>
