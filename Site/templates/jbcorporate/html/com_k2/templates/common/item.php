...
<div id = "zenkit" class="itemView <?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	  ...
	  <?php endif; ?>
		...
		<div class="jbMeta zenmeta">
			...
			<div class="jbAuthor zenauthor">
				<span><?php echo K2HelperUtilities::writtenBy($this->item->author->profile->gender); ?></span>&nbsp;
					...
					<li class="commentanchor">
						...
						<?php else: ?>
							...
							<a class="commentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
								<span><span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?></span>
							</a>
							<?php else: ?>
							<a class="commentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
								<span><?php echo JText::_('K2_BE_THE_FIRST_TO_COMMENT'); ?></span>
							</a>
							<?php endif; ?>
						<?php endif; ?>
					</li>
  ...
  <div class="itembody">
	...
	<h3><?php echo JText::_('K2_MEDIA'); ?></h3>
			...
			<div class="videoEmbedded border">
