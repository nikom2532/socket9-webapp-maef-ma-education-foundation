...
// Load the filter script - code at bottom
$doc->addScript( $template.'/html/com_k2/media/filter/jquery.isotope.min.js');

?>
<!-- Start K2 Category Layout -->
<div id = "zenkit" class="itemListView filter <?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<ul id="zenfilters" class="zentabs">
	...
	<div class="k2ItemList">
		...
		<?php if(isset($this->leading) && count($this->leading)): ?>
					<div id="k2ItemListLeading">
						...
						<div class="k2ItemContainer<?php echo $lastContainer; ?> element <?php foreach ($item->tags as $tag): ?>
						<?php echo $tag->name; ?>
						<?php endforeach; ?> grid_<?php echo number_format($this->params->get('num_leading_columns')) ?>">
							<?php
		...
		<div id="container">
			...
			<div class="k2ItemContainer<?php echo $lastContainer; ?> grid_<?php echo number_format($this->params->get('num_primary_columns')) ?>">
					<?php
						// Load category_item.php by default
						$this->item=$item;
						echo $this->loadTemplate('item');
...
<script type="text/javascript">
	jQuery(window).ready(function(){
		...
		var seen = {};
		jQuery('#zenfilters li').each(function() {
		...
		// cache container
		var jQuerycontainer = jQuery('#k2ItemListLeading');
		...
		jQuerycontainer.imagesLoaded( function(){
		 ...
		 masonry: { columnWidth: jQuerycontainer.width() / <?php echo number_format($this->params->get('num_leading_columns')) ?> }
			

			});
			
			//	alert(jQuerycontainer.width() / (<?php echo number_format($this->params->get('num_leading_columns')) ?> - 0.01));
			
		
			// filter items when filter link is clicked
			jQuery('#zenfilters a').click(function(){
			  ...
			  jQuerycontainer.isotope({ 
				...
				jQuery('#zenfilters a').removeClass('active');
