...
<a class="printThisPage" rel="nofollow" href="#" onclick="window.print();return false;">
...
<div id = "zenkit" class="itemView blog <?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<div class="blogbuttons">
		<ul>
			...
			<!-- Print Button -->
			<li class="print">
				<a class="printLink" rel="nofollow" href="<?php echo $this->item->printLink; ?>" onclick="window.open(this.href,'printWindow','width=900,height=600,location=no,menubar=no,resizable=yes,scrollbars=yes'); return false;">
				</a>
			</li>
			<?php endif; ?>
			...
			<!-- Email Button -->
			<li class="email">
				<a class="emailLink" rel="nofollow" href="<?php echo $this->item->emailLink; ?>" onclick="window.open(this.href,'emailWindow','width=400,height=350,location=no,menubar=no,resizable=no,scrollbars=no'); return false;">
				</a>
			</li>
			<?php endif; ?>
			...
			<!-- Font Resizer -->
			<li class="resize">
				<a href="#" id="fontIncrease">A</a>
				<a href="#" id="fontDecrease">a</a>
			</li>
			<?php endif; ?>
		</ul>
	</div>
	...
	<div class="clear"></div>
	 ...
	 <!-- Plugins: AfterDisplayTitle -->
	  ...
	  <div class="imageblock">
		  ...
		  <!-- Image caption -->
		  <span class="imagecaption"><?php echo $this->item->image_caption; ?></span>
		  <?php endif; ?>

		  <?php if($this->item->params->get('itemImageMainCredits') && !empty($this->item->image_credits)): ?>
		  <!-- Image credits -->
		  <span class="imagecredits"><?php echo $this->item->image_credits; ?></span>
		  <?php endif; ?>
	 ...
	 <?php if($this->item->params->get('itemVideo') && !empty($this->item->video)): ?>
	  ...
	  <div class="videoBlock zenblock">
	  	<h3><?php echo JText::_('K2_MEDIA'); ?></h3>
			...
			<?php else: ?>
			<span class="video"><?php echo $this->item->video; ?></span>
			<?php endif; ?>

		  <?php if($this->item->params->get('itemVideoCaption') && !empty($this->item->video_caption)): ?>
		  <span class="videoCaption"><?php echo $this->item->video_caption; ?></span>
		  <?php endif; ?>

		  <?php if($this->item->params->get('itemVideoCredits') && !empty($this->item->video_credits)): ?>
		  <span class="videoCredits"><?php echo $this->item->video_credits; ?></span>
		  <?php endif; ?>
	  ...
	  <!-- Item fulltext -->
	  	<div class="k2FullText itemFullText zenblock">
	  ...
	  <?php endif; ?>
		...
		<div class="zenblock">
		  ...
		  <div class="navigation">
		  	<span class="navigationTitle"><?php echo JText::_('K2_MORE_IN_THIS_CATEGORY'); ?></span>

				<?php if(isset($this->item->previousLink)): ?>
				<a class="previous" href="<?php echo $this->item->previousLink; ?>">
					&laquo; <?php echo $this->item->previousTitle; ?>
				</a>
				<?php endif; ?>

				<?php if(isset($this->item->nextLink)): ?>
				<a class="next" href="<?php echo $this->item->nextLink; ?>">
	...
	<div class="socialSharing zenblock">
		...
		<!-- Twitter Button -->
		<div class="twitterButton grid_three">
		...
		<!-- Facebook Button -->
		<div class="itemFacebookButton grid_three">
			<div id="fb-root"></div>
		...
		<!-- Google +1 Button -->
		<div class="googlePlusOneButton grid_three zenlast">	
  ...
  <div class="authorBlock">
	    	...
	    	<div class="authorDetails">
		      ...
		      <span class="authorUrl"><?php echo JText::_('K2_WEBSITE'); ?> <a rel="me" href="<?php echo $this->item->author->profile->url; ?>" target="_blank"><?php echo str_replace('http://','',$this->item->author->profile->url); ?></a></span>
		      <?php endif; ?>

		      <?php if($this->item->params->get('itemAuthorEmail')): ?>
		      <span class="authorEmail"><?php echo JText::_('K2_EMAIL'); ?> <?php echo JHTML::_('Email.cloak', $this->item->author->email); ?></span>
		      <?php endif; ?>
	...
	<div class="related zenblock">
		...
		<ul>
			...
			<li class="<?php echo ($key%2) ? "odd" : "even"; ?>">
				...
				<a class="relTitle" href="<?php echo $item->link ?>"><?php echo $item->title; ?></a>
				<?php endif; ?>

				<?php if($this->item->params->get('itemRelatedCategory')): ?>
				<div class="relCat"><?php echo JText::_("K2_IN"); ?> <a href="<?php echo $item->category->link ?>"><?php echo $item->category->name; ?></a></div>
				<?php endif; ?>
				
				<?php if($this->item->params->get('itemRelatedAuthor')): ?>
				<div class="relAuthor"><?php echo JText::_("K2_BY"); ?> <a rel="author" href="<?php echo $item->author->link; ?>"><?php echo $item->author->name; ?></a></div>
				<?php endif; ?>
				...
				<div class="relIntrotext"><?php echo $item->introtext; ?></div>
				<?php endif; ?>
				
				<?php if($this->item->params->get('itemRelatedFulltext')): ?>
				<div class="relFulltext"><?php echo $item->fulltext; ?></div>
				<?php endif; ?>

				<?php if($this->item->params->get('itemRelatedMedia')): ?>
				<?php if($item->videoType=='embedded'): ?>
				<div class="relMediaEmbedded"><?php echo $item->video; ?></div>
				<?php else: ?>
				<div class="relMedia"><?php echo $item->video; ?></div>
				<?php endif; ?>
				<?php endif; ?>
				
				<?php if($this->item->params->get('itemRelatedImageGallery')): ?>
				<div class="relImageGallery"><?php echo $item->gallery; ?></div>
				<?php endif; ?>
			</li>
			<?php endforeach; ?>
			<li class="clr"></li>
 ...
 <?php if($this->item->params->get('itemComments') && ($this->item->params->get('comments') == '1' || ($this->item->params->get('comments') == '2')) && empty($this->item->event->K2CommentsBlock)): ?>
  ...
  <div class="comments zenblock">
	  ...
	  <!-- Item user comments -->
	  <h3 class="commentsCounter">
	  	<span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
	  </h3>

	  <ul class="commentsList">
	    <?php foreach ($this->item->comments as $key=>$comment): ?>
	    <li class="<?php echo ($key%2) ? "odd" : "even"; echo (!$this->item->created_by_alias && $comment->userID==$this->item->created_by) ? " authorResponse" : ""; echo($comment->published) ? '':' unpublishedComment'; ?> zenblock">
				...
				<div class="grid_three">
					<?php if($comment->userImage): ?>
						<img class="commentavatar" src="<?php echo $comment->userImage; ?>" alt="<?php echo JFilterOutput::cleanText($comment->userName); ?>" width="<?php echo $this->item->params->get('commenterImgWidth'); ?>" />
					<?php endif; ?>
	...
	<div class="blogsidebar">
		...
		<?php if($this->item->params->get('itemAuthor')): ?>
			...
			<?php if($this->item->params->get('itemAuthorImage') && !empty($this->item->author->avatar)): ?>
		  		<img class="authorAvatar" src="<?php echo $this->item->author->avatar; ?>" alt="<?php echo K2HelperUtilities::cleanHtml($this->item->author->name); ?>" />
		  	<?php endif; ?>
			
			<!-- Item Author -->
			<div class="jbAuthor zenauthor">
				<?php if(empty($this->item->created_by_alias)): ?>
				<span><a rel="author" href="<?php echo $this->item->author->link; ?>"><?php echo $this->item->author->name; ?></a></span>
				<?php else: ?>
		...
		<?php if($this->item->params->get('itemAuthorDescription') && !empty($this->item->author->profile->description)): ?>
	      <blockquote><p><?php echo $this->item->author->profile->description; ?></p></blockquote>
	    <?php endif; ?>
		...
		<?php if(
				...
				<div class="buttons">
					<ul>
						...
						<li>
							<!-- Item category -->
							<span class="jbCategories zencategories">
								<strong><span><?php echo JText::_('K2_PUBLISHED_IN'); ?></span></strong>
						...
						<li class="commentanchor">
							...
							<?php else: ?>
								...
								<a class="commentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
									<span><?php echo $this->item->numOfComments; ?></span> <?php echo ($this->item->numOfComments>1) ? JText::_('K2_COMMENTS') : JText::_('K2_COMMENT'); ?>
								</a>
								<?php else: ?>
								<a class="commentsLink k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
