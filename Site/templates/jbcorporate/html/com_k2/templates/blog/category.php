...
<div id = "zenkit" class="itemListView <?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<div class="k2ItemList">
		...
		<div id="k2ItemListPrimary">
			...
			<?php
			// Define a CSS class for the last container on each row
			if( (($key+1)%($this->params->get('num_primary_columns'))==0))
				$lastContainer= ' zenlast';
			else
				$lastContainer='';
			?>
