...
<div class="catItemView blog zenblock group<?php echo ucfirst($this->item->itemGroup); ?><?php echo ($this->item->featured) ? ' catItemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
  ...
  <div class="clear"></div>
	...
	<div class="readMore zenbutton">
		<span>
		<a class="jbReadon zenbutton" href="<?php echo $this->item->link; ?>">
