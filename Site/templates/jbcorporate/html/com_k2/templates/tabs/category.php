...
<div id = "zenkit" class="itemListView tabs<?php if($this->params->get('pageclass_sfx')) echo ' '.$this->params->get('pageclass_sfx'); ?>">
	...
	<ul class="zentabs">
		...
		<div class="clear"></div>
		<div class="zentab_container">
			<?php if((isset($this->leading) || isset($this->primary) || isset($this->secondary) || isset($this->links)) && (count($this->leading) || count($this->primary) || count($this->secondary) || count($this->links))): ?>
				<!-- Item list -->
				<div id="zentab1" class="zentab_content">
		...
		<!-- Primary items -->
		<div id="zentab2" class="zentab_content">
		...
		<!-- Secondary items -->
		<div id="zentab3" class="zentab_content">
...
jQuery(document).ready(function(){	
	...
	//Default Action
	jQuery(".zentab_content").hide(); //Hide all content
	jQuery("ul.zentabs li:first").addClass("active").show(); //Activate first tab
	jQuery(".zentab_content:first").show(); //Show first tab content
	
	// js for zentabs
	jQuery("ul.zentabs li").click(function(){
		jQuery("ul.zentabs li").removeClass("active");
		jQuery(this).addClass("active");
		jQuery(".zentab_content").hide();
	...
	<?php if($this->params->get('pageclass_sfx')==" accordion") {?>
		jQuery('#zenkit.accordion #k2ItemListPrimary .contentheading').click(function() {
			...
			jQuery('#zenkit.accordion #k2ItemListPrimary .accordionbody').removeClass('open');
		...
		jQuery('#zenkit.accordion #k2ItemListPrimary .firstitem').addClass('open');
