		...
		if ($zgfEnabled) {
			...
			switch ($display){
				...
				case "listcss":
					...
					$path		= JPATH_ROOT.DS.'templates'.DS.Zengrid::getTemplate().DS.'css';
						...
						case "filelist":
							...
							case "logofile":
								...
								case "logolocation":
									...
									return JHTML::_('select.genericlist',  $options, ''.$control_name.'['.$name.']', $class, 'value', 'text', str_replace('[template]', Zengrid::getTemplate(), $value), $control_name.$name);
									break;
				default:
					return;
					break;
