...
;(function (jQuery) {
  ...
  jQuery.flexslider = function(el, options) {
    ...
    slider.init = function() {
      ...
      slider.container = jQuery('.slides', slider);
      slider.slides = jQuery('.slides > li', slider);
      ...
      if (slider.vars.animation.toLowerCase() == "slide") {
        ...
        slider.newSlides = jQuery('.slides > li', slider);
      ...
      slider.destroy = function() {
        ...
        if (slider.vars.keyboardNav && jQuery('ul.slides').length == 1) jQuery(document).unbind('keyup', keyboardMove);
  ...
  jQuery.fn.flexslider = function(options) {
    return this.each(function() {
      ...
      else if (jQuery(this).data('flexslider') != true) {
        new jQuery.flexslider(jQuery(this), options);
      }
    });
  }  
